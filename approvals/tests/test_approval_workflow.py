    ...
    for p in purchase_orders:
        if flt(po.grand_total) < 200.00:
            ...
            assert frappe.db.exists(
                "ToDo", {"allocated_to": "mmckay@cfc.co", "reference_name": po.name}
            )
